...
public class DuplicateReadCountsUnitTest {
    ...
    @Test
    public void testSingleDuplicates() throws IOException {
        final ReadLikelihoods<Allele> likelihoods = createTestLikelihoods(false, Optional.empty());
    ...
    public void testMultipleDuplicateSets() throws IOException {
        ...
        final int shiftBy1 = 3;
        final ReadLikelihoods<Allele> likelihoods1 = createTestLikelihoods(true, Optional.of(shiftBy1));
        ...
        Assert.assertEquals(uniqueReadSetCount1, shiftBy1);

        // here ALT reads are all distinct
        final int shiftBy2 = 12;
        final ReadLikelihoods<Allele> likelihoods2 = createTestLikelihoods(true, Optional.of(shiftBy2));
        ...
        Assert.assertEquals(uniqueReadSetCount2, shiftBy2);
    }


    private ReadLikelihoods<Allele> createTestLikelihoods(final boolean shiftReads, Optional<Integer> shiftBy) {
